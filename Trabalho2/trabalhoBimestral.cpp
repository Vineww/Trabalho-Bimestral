...
//alunos: Bianca Amaral Morgan, Vinícius Vicari, Pedro Henrique Caetano
...
void escreve_Resultado(const Flower flowers[], int numFlowers)
{
...
int main()
{
    ...
    escreve_Resultado(flowers, numFlowers);
